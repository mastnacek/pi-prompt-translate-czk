...
const PROMPT_TRANSLATE_SYSTEM_PROMPT = [
...
const PROMPT_BOOST_SYSTEM_PROMPT = [
...
const PROMPT_MEGA_SYSTEM_PROMPT = [
...
const ENGLISH_ONLY_AGENT_INSTRUCTION = [
...
const LEGACY_RESPONSE_TRANSLATION_INSTRUCTION =
...
const RESPONSE_TRANSLATION_ENABLED_INSTRUCTION =
...
const RESPONSE_TRANSLATION_DISABLED_INSTRUCTION =
...
function buildEnglishOnlyInstruction(translateResponses: boolean): string {
	return [
...
function stripResponseTranslationInstructions(systemPrompt: string): string {
	return systemPrompt
		.split("\n")
		.filter(
			(line) =>
...
function appendEnglishOnlyInstruction(
	systemPrompt: string,
